...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(ChartCurrentRates, [{
    ...
    value: function getChartData() {
      ...
      fetch("http://data.fixer.io/api/latest?access_key=".concat(API_KEY, "&base=USD\n    & symbols = GBP,JPY,EUR")).then(function (res) {
        return res.json();
      }).then(function (json) {
        _this2.setState({
          chartData: {
...
//# sourceMappingURL=index.js.092af2cecb8616517f68.hot-update.js.map