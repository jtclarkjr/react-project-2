...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(ChartCurrentRates, [{
    ...
    value: function getChartData() {
      ...
      fetch("http://data.fixer.io/api/latest?access_key=".concat(API_KEY, "&base=USD")).then(function (res) {
        return res.json();
      }).then(function (json) {
        _this2.setState({
          jsonData: json,
          currentDataJPY: json.date,
          currentRateJPY: json.rates.JPY,
          chartData: {
            labels: ['China', 'Japan', 'Korea'],
            datasets: [{
              data: [json.rates.CNY, json.rates.JPY, json.rates.KWR]
            }]
          }
        });
      });
...
//# sourceMappingURL=index.js.10d7cbdc1f530e41e980.hot-update.js.map