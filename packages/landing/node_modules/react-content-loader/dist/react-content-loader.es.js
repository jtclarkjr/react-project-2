...
var Svg = (function (_a) {
    ...
    return (createElement("svg", __assign({ role: "img", style: __assign({}, style, rtlStyle), className: className, "aria-labelledby": ariaLabel ? ariaLabel : null, viewBox: "0 0 " + width + " " + height, preserveAspectRatio: preserveAspectRatio }, props),
        ariaLabel ? createElement("title", null, ariaLabel) : null,
        createElement("rect", { x: "0", y: "0", width: width, height: height, clipPath: "url(#" + idClip + ")", style: { fill: "url(#" + idGradient + ")" } }),
        createElement("defs", null,
            createElement("clipPath", { id: idClip }, children),
            createElement("linearGradient", { id: idGradient },
                createElement("stop", { offset: "0%", stopColor: primaryColor, stopOpacity: primaryOpacity }, animate && (createElement("animate", { attributeName: "offset", values: "-3; 1", dur: speed + "s", repeatCount: "indefinite" }))),
                createElement("stop", { offset: "50%", stopColor: secondaryColor, stopOpacity: secondaryOpacity }, animate && (createElement("animate", { attributeName: "offset", values: "-2; 2", dur: speed + "s", repeatCount: "indefinite" }))),
                createElement("stop", { offset: "100%", stopColor: primaryColor, stopOpacity: primaryOpacity }, animate && (createElement("animate", { attributeName: "offset", values: "-1; 3", dur: speed + "s", repeatCount: "indefinite" })))))));
});
