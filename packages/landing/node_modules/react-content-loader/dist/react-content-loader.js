(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Svg = (function (_a) {
        ...
        return (React.createElement("svg", __assign({ role: "img", style: __assign({}, style, rtlStyle), className: className, "aria-labelledby": ariaLabel ? ariaLabel : null, viewBox: "0 0 " + width + " " + height, preserveAspectRatio: preserveAspectRatio }, props),
            ariaLabel ? React.createElement("title", null, ariaLabel) : null,
            React.createElement("rect", { x: "0", y: "0", width: width, height: height, clipPath: "url(#" + idClip + ")", style: { fill: "url(#" + idGradient + ")" } }),
            React.createElement("defs", null,
                React.createElement("clipPath", { id: idClip }, children),
                React.createElement("linearGradient", { id: idGradient },
                    React.createElement("stop", { offset: "0%", stopColor: primaryColor, stopOpacity: primaryOpacity }, animate && (React.createElement("animate", { attributeName: "offset", values: "-3; 1", dur: speed + "s", repeatCount: "indefinite" }))),
                    React.createElement("stop", { offset: "50%", stopColor: secondaryColor, stopOpacity: secondaryOpacity }, animate && (React.createElement("animate", { attributeName: "offset", values: "-2; 2", dur: speed + "s", repeatCount: "indefinite" }))),
                    React.createElement("stop", { offset: "100%", stopColor: primaryColor, stopOpacity: primaryOpacity }, animate && (React.createElement("animate", { attributeName: "offset", values: "-1; 3", dur: speed + "s", repeatCount: "indefinite" })))))));
    });
